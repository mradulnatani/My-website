  ...
  <div className="col">
    <div className="card" style={{height:'100%',width:'100%'}}>
      ...
      <div className="card-body">
        ...
        <a href='https://github.com/mradulnatani/lottery-Dapp'><button style={{backgroundColor:'blue',color:'white',borderRadius:'5px',width:'120px'}}>Github</button></a>
      </div>
    </div>
  </div>
  <div className="col">
    <div className="card" style={{height:'100%',width:'100%'}}>
      ...
      <div className="card-body">
        ...
        <a href='https://github.com/mradulnatani/MYnft'><button style={{backgroundColor:'blue',color:'white',borderRadius:'5px',width:'120px'}}>Github</button></a>
      </div>
    </div>
  </div>
  <div className="col">
    <div className="card"style={{height:'100%',width:'100%'}}>
      ...
      <div className="card-body">
        ...
        <a href='https://github.com/mradulnatani/My-website'><button style={{backgroundColor:'blue',color:'white',borderRadius:'5px',width:'120px'}}>Github</button></a>
      </div>
    </div>
  </div>
